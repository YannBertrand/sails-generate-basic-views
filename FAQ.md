...
```sh
$ npm install sails-generate-basic-views
```

[![NPM](https://nodei.co/npm/sails-generate-basic-views.png?downloads=true&stars=true)](https://nodei.co/npm/sails-generate-basic-views/)
